...
{{< cards >}}
  {{< card link="kpi-roi" title="KPI & ROI Analysis" icon="chart-bar" >}}
  {{< card link="time-to-market" title="Time-to-Market" icon="clock" >}}
  {{< card link="bm-innovation" title="Business Model Innovation" icon="lightning-bolt" >}}
  {{< card link="scaleup" title="Scale-up Strategy" icon="trending-up" >}}
{{< /cards >}}
